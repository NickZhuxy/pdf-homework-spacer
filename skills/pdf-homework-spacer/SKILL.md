...
- Do not discard interactive content to obtain a visually similar result. The current helper rejects links, annotations, form fields, outlines, attachments and optional-content layers rather than silently losing them. Do not bypass this by removing or baking those features.
